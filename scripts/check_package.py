...
ALLOWED_RUNTIME_FILES = {
    ...
    "vitrine/starter_profiles.py",
    "vitrine/starter_profile_data/__init__.py",
    "vitrine/starter_profile_data/catalog.json",
    "vitrine/starter_profile_data/improvement_portfolio_v1.json",
    "vitrine/starter_profile_data/showcase_portfolio_v1.json",
...
REQUIRED_SDIST_FILES = {
    ...
    "docs/contracts/starter-portfolio-profiles-v1.md",
    "docs/contracts/producer-projection-adapters-v1.md",
    "docs/contracts/installed-producer-reader-services-v1.md",
    ...
    "docs/development/starter-portfolio-profiles.md",
    ...
    "scripts/smoke_test_starter_profiles_wheel.py",
    ...
    "scripts/validate_starter_profiles.py",
    ...
    "tests/test_starter_profiles.py",
    "vitrine/starter_profiles.py",
    "vitrine/starter_profile_data/__init__.py",
    "vitrine/starter_profile_data/catalog.json",
    "vitrine/starter_profile_data/improvement_portfolio_v1.json",
    ...
    "tests/test_validate_quillan_adapter.py",
    ...
    "docs/contracts/quillan-live-adapter-v1.md",
    "docs/contracts/quillan-artifact-source-provider-v1.md",
